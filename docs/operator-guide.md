...
2. Register the client's intake: business type, the specific
   MIC-regulated activity involved, prior filing/compliance
   history in Japan if any.
3. Run the advisor in read-only mode against Ministry of Internal Affairs and Communications's
   (総務省) published guidance.
...
5. Enable gated filing/compliance-draft assistance once the
   Telecom-Licensing Compliance Governor contract is trusted; actual submission always
...
automated actions cannot bypass the Telecom-Licensing Compliance Governor, and a working
